...
import 'package:graystone/graystone_i2c.dart';

void main() {

  final firmataConn = new FirmataConnection();
  final lcd = new Lcd(firmataConn, pins = [12, 11, 5, 4, 3, 2], size =[16, 2]);

  new Robot([firmataConn], [lcd])
    ..behaviour = (() => lcd.print("Hello world"))
    ..start();
